...
ezOptionValidator::ezOptionValidator(char _type, char _op,
    ...
    : insensitive(0), op(_op), size(_size), u1(0), type(_type), quiet(0) {
    id = ezOptionParserIDGenerator::instance().next();
...
ezOptionValidator::ezOptionValidator(char _type, char _op, const short* list,
                                     int _size)
    : insensitive(0), op(_op), size(_size), s2(0), type(_type), quiet(0) {
    id = ezOptionParserIDGenerator::instance().next();
    s2 = new short[size];
...
ezOptionValidator::ezOptionValidator(char _type, char _op,
    ...
    : insensitive(0), op(_op), size(_size), u2(0), type(_type), quiet(0) {
    id = ezOptionParserIDGenerator::instance().next();
...
ezOptionValidator::ezOptionValidator(char _type, char _op, const int* list,
                                     int _size)
    : insensitive(0), op(_op), size(_size), s4(0), type(_type), quiet(0) {
    id = ezOptionParserIDGenerator::instance().next();
    s4 = new int[size];
...
ezOptionValidator::ezOptionValidator(char _type, char _op,
    ...
    : insensitive(0), op(_op), size(_size), u4(0), type(_type), quiet(0) {
    id = ezOptionParserIDGenerator::instance().next();
...
ezOptionValidator::ezOptionValidator(char _type, char _op,
    ...
    : insensitive(0), op(_op), size(_size), s8(0), type(_type), quiet(0) {
    id = ezOptionParserIDGenerator::instance().next();
...
ezOptionValidator::ezOptionValidator(char _type, char _op,
    ...
    : insensitive(0), op(_op), size(_size), u8(0), type(_type), quiet(0) {
    id = ezOptionParserIDGenerator::instance().next();
...
ezOptionValidator::ezOptionValidator(char _type, char _op, const float* list,
                                     int _size)
    : insensitive(0), op(_op), size(_size), f(0), type(_type), quiet(0) {
    id = ezOptionParserIDGenerator::instance().next();
    f = new float[size];
...
ezOptionValidator::ezOptionValidator(char _type, char _op, const double* list,
                                     int _size)
    : insensitive(0), op(_op), size(_size), d(0), type(_type), quiet(0) {
    id = ezOptionParserIDGenerator::instance().next();
    d = new double[size];
...
ezOptionValidator::ezOptionValidator(char _type, char _op, const char** list,
    ...
    : insensitive(_insensitive), op(_op), size(_size), t(0), type(_type),
      quiet(0) {
    id = ezOptionParserIDGenerator::instance().next();
    ...
    if (type != T) {
        ...
        case F: {
            ...
            if (dvalue < dmin) {
                if (!quiet) {
                    fprintf(stderr,
                            "ERROR: Invalid value %g is less than datatype min "
                            "%g.\n",
                            dvalue, dmin);
                }
                return false;
